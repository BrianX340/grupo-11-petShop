...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-10-2021 a las 05:59:15
...
CREATE TABLE `product` (
  ...
  `isInPromotion` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `product` (`id`, `name`, `buyPrice`, `sellPrice`, `discount`, `valoration`, `stock`, `description`, `barcode`, `imgPath`, `totalSells`, `totalViews`, `categoryId`, `subCategoryId`, `isBestSell`, `isInPromotion`) VALUES
...
(37, 'Brayan', 'Rodriguez', 'brianx340@gmail.com', '$2a$10$3x9.H8FFYqH48qeLFTXBfeqDIQnQ1unl6n3GHWsB.eRsBnInQV4zG', 1, 1134489022, 36, 1);
