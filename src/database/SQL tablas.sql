...
(14, 'Tempcore Cama de gato para gatos de interior', 5191, 5249, NULL, 3, 265, 'Privacidad y comodidad: la cama para gatos TEMPCORE le da a tus amigos peludos algo de privacidad. Se sienten seguros y protegidos, mejorando su comodidad general. Debido a que tiene una entrada ancha con capucha, que los mantiene cómodos, frescos y trans', 2147483647, 'camaGato9.jpg', 0, 0, 1, 4, 1, 0),
(15, 'Arm & Hammer Kit de Tartar Control para perros', 472, 1047, 71, 3, 104, 'El nombre Arm & Hammer es sinónimo de salud dental y es exactamente por eso que se ha convertido en una marca dental líder en el espacio para mascotas con una amplia variedad de productos con el objetivo de facilitar el cuidado de sus compañeros caninos.', 2147483647, 'higienePerro8.jpg', 0, 0, 2, 2, 1, 0),
(16, 'Pedigree Comida seca para perros para adultos, sabor a pollo', 6102, 9819, NULL, 2, 221, 'Cada perro se merece lo mejor ... es por eso que PEDIGREE Complete Nutrition Dry Dog Food ofrece una nutrición 100% completa y equilibrada para su perro adulto. Tiene los antioxidantes, vitaminas y minerales que los caninos necesitan para ayudar a mantene', 1124755411, 'alimentoPerro10.jpg', 0, 0, 2, 1, 1, 0);